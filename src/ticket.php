...
<div class="container mt-5 text-center">
    <div class="card shadow p-5">
        <h1 class="text-success">Registre Exitós!</h1>
        <p class="lead">La teva incidència amb <strong>ID: <?php echo $incidencia["id"] ?></strong> ha sigut registrada correctament</p>
        ...
        <ul class="list-group list-group-flush text-start mb-4">
            <li class="list-group-item"><strong>Nom:</strong> <?php echo htmlspecialchars($incidencia["title"]) ?></li>
            <li class="list-group-item"><strong>Departament:</strong> <?php echo htmlspecialchars($department["nom"]) ?></li>
            <li class="list-group-item"><strong>Data:</strong> <?php echo htmlspecialchars($incidencia["data_incidencia"]) ?></li>
        </ul>

        <div class="d-grid gap-2 d-md-block">
            <a href="/" class="btn btn-primary">Tornar a l'inici</a>
            <a href="formulari_incidencia.php" class="btn btn-secondary">Registrar nova incidència</a>
        </div>
    </div>
</div>
