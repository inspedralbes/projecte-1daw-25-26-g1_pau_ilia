...
<head>
    <title>Detalls de incidencia</title>
            ...
            <form action="actualitzar_incidencia.php" method="POST">
                ...
                <input type="hidden" name="bulk_update" value="1"> <div class="row"> 
                    <div class="col-md-6 mb-2">
                        <div class="card bg-dark text-light p-3 position-relative border-secondary">
                            <a href="delete_incidencia.php?id=<?php echo $incidencia["id"]?>" class="delete-btn position-absolute bg-secondary btn-secondary  shadow-sm">
                                <i class="bi fs-3 text-primary bi-trash3-fill"></i>
                            </a>
