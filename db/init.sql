...
CREATE TABLE incidencies (
    ...
    estado ENUM('Registrat', 'En Proces', 'Finalitzat') DEFAULT 'Registrat',
    ...
    FOREIGN KEY (tipus_id) REFERENCES tipus_incidencia(id) ON DELETE SET NULL
);
...
INSERT INTO incidencies (departament_id, data_incidencia, descripcio, tecnic_id, tipus_id, prioritat, resolta, data_finalitzacio) VALUES 
(1, '2024-03-01', 'No funciona la impressora del departament', NULL, NULL, NULL, FALSE, NULL),
(2, '2024-03-02', 'El projector de l''aula 3 no s''encén', 1, 1, 'Alta', FALSE, NULL),
(3, '2024-03-03', 'No hi ha internet als ordinadors dels alumnes', 3, 3, 'Alta', TRUE, '2024-03-04'),
